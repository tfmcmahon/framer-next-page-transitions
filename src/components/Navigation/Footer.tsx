...
const Footer = () => (
  <footer className="text-gray-300 body-font bg-gray-800">
    <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
      <div className="flex-shrink-0 w-64 mx-auto mt-10 text-center md:mx-0 md:text-left lg:mt-0">
      ...
      <div className="flex flex-wrap flex-grow order-first text-center md:pr-20 md:text-left">
        <div className="w-full lg:pr-4 lg:w-1/4 md:w-1/2 pb-10 lg:pb-0">
          <h2 className="mb-3 text-sm font-medium tracking-widest text-gray-300 title-font">
            CATEGORIES
          </h2>
          <FooterLinks
        ...
        <div className="w-full lg:px-4 lg:w-1/4 md:w-1/2 pb-10 md:pb-0">
          <h2 className="mb-3 text-sm font-medium tracking-widest text-gray-300 title-font">
            CATEGORIES
          </h2>
          <FooterLinks
        ...
        <div className="w-full lg:px-4 lg:w-1/4 md:w-1/2">
          <h2 className="mb-3 text-sm font-medium tracking-widest text-gray-300 title-font">
            CATEGORIES
          </h2>
          <FooterLinks
